...
% ===========================================================================
% PAQUETS (mateixos que la memòria)
% ===========================================================================
...
\usepackage{mathpazo}
\usepackage{beramono}
\usepackage[margin=2.5cm, top=1.5cm, bottom=1.5cm, inner=2.5cm, outer=3.8cm, bindingoffset=.5cm]{geometry}
\usepackage{hyperref}
\usepackage{xurl}
...
% ===========================================================================
% CONFIGURACIÓ D'ESTIL (mateixa que la memòria)
% ===========================================================================
...
% Capçaleres i peus (mateix estil que la memòria)
\pagestyle{fancy}
\fancyhf{}
...
% Formatació de títols
\titleformat{\section}{\Large\bfseries}{}{0em}{}
\titleformat{\subsection}{\large\bfseries}{}{0em}{}

% Logo UdG
\graphicspath{{Figures/}{../memoriaTFG/Front/Figures/}{../memoriaTFG/Figures/}}
...
% ===========================================================================
% PORTADA (mateix estil que la memòria)
% ===========================================================================
...
\begin{center}
\includegraphics[width=0.65\textwidth]{EPS_centrat.png}

\vspace{2cm}

{\Large\textbf{Grau en Enginyeria Informàtica}\par}
\vspace{0.2cm}
\vspace{2.5cm}
\textsc{\Large Treball de Fi de Grau}
\vspace{0.2cm}

\rule{.9\linewidth}{.6pt}
\vspace{0.4cm}
{\huge\bfseries Visualitzador de Dades Obertes sobre Recursos Hídrics de Catalunya\par}
\vspace{0.4cm}
\rule{.9\linewidth}{.6pt}
\vspace{1cm}
...
\vspace{2.5cm}
\textsc{\Large Resum del Treball de Fi de Grau}
\vspace{0.2cm}
...
Aquest projecte aborda aquesta bretxa creant un sistema integrat de visualització de dades hídriques que consolida informació de 9 embassaments i més de 200 estacions meteorològiques provinent de les APIs públiques de la Generalitat de Catalunya. El sistema combina un pipeline ETL automatitzat amb Node.js que s'executa diàriament mitjançant GitHub Actions amb un frontend interactiu basat en React.
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Implementar lògica de detecció de sequera}: Definir llindars de perill basats en percentatge d'ocupació (crític \textless20\%, avís 20-50\%, normal 50-75\%, òptim \textgreater75\%).
...
Pel que fa a l'aprenentatge, el projecte ha representat una oportunitat valuosa per aplicar coneixements del grau en un context real, desenvolupant competències tècniques (Node.js, React, CI/CD) i de gestió (estimació precisa amb error de només 3,2\% respecte a les 330 hores estimades).
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Vídeo de demostració:} \url{https://ggl.link/demo-web}

    \item \textbf{Vídeo d'explicació del codi:} \url{https://ggl.link/demo-codi}
\end{itemize}
