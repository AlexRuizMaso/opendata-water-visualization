...
\begin{itemize}
    ...
    \item \textbf{Consultes informals}: Interaccions esporàdiques amb companys del grau i professionals del sector de l'aigua per a validació de supòsits i obtenció de perspectives d'usuari, totalitzant aproximadament 10 hores de consultes no formals.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Actualitat}: Els conjunts de dades d'embassaments s'actualitzen cada 15 minuts, mentre que els de precipitació s'actualitzen cada hora, assegurant que les dades disponibles siguin raonablement actuals.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{axios 1.4.0}: Biblioteca HTTP amb API basada en promeses, maneig centralitzat d'encapçalaments i reintents automàtics.
    \item \textbf{dotenv 16.0.3}: Gestió segura de variables d'entorn per a separar configuració del codi font.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Sass 1.99}: Preprocessador CSS amb metodologia BEM per a mantenibilitat.
\end{itemize}
