...
\begin{itemize}
    ...
    \item \textbf{Optimització de rendiment amb grans volums}: Per a conjunts de dades superiors a 200.000 registres, es podria implementar virtualització de llistes i càrrega progressiva per evitar bloquejos del navegador.
