...
\begin{itemize}
    ...
    \item S'hi van assignar 12 hores de col·loqui (10\%) per a revisions de progrés i ajusts del pla de treball, essencials en una metodologia àgil.
\end{itemize}
...
\begin{enumerate}
    \item \textbf{Ampliació del scope de fonts de dades}: El pla original previstia d'utilitzar únicament dades de l'embassament de Raimat per a la prova de concepte. Tot i això, durant la Fase 1 es va comprovar la facilitat d'accés a les dades de tots els embassaments principals de Catalunya a través de les APIs de Socrata. Es va decidir ampliar el scope a 9 embassaments (Sau, Susqueda, La Baells, Cambrils, Riudecanyes, Foix, Castelló de Farfanya, Sant Ponç i Raimat) per a proporcionar una visió més completa i representativa del territori català. Aquesta decisió va incrementar l'esforç de la Fase 2 en aproximadament 8 hores però va augmentar significativament el valor del projecte per a usuaris professionals i acadèmics.
    
    \item \textbf{Canvi d'enfocament en la visualització de correlació}: Inicialment es va planificar utilitzar mapes de calor per a mostrar la correlació entre precipitació i nivells d'embassament. Tot i això, durant les proves inicials de la Fase 3 es va observar que aquesta representació obscudia les tendències temporals i podia conduir a interpretacions errònies. Es va canviar per a un gràfic de dispersió amb línies de tendència i càlcul del coeficient de correlació, proporcionant una mesura quantitativa més rigorosa i una visibilitat més accessible per a l'usuari. Aquest canvi va requerir 4 hores addicionals de desenvolupament en la Fase 4 però va millorar notablement la qualitat analítica del Dashboard 3.
...
\begin{itemize}
    ...
    \item La flexibilitat inherents a la metodologia àgil va permetre incorporar millores significatives sense comprometre els límits temporals.
