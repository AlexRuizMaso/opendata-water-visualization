...
En aquest capítol s'analitzen les deduccions extretes del procés de desenvolupament i es presenta la feina realitzada en el disseny del sistema. S'hi descriuen els tipus d'usuari, l'anàlisi detallada dels requisits, els casos d'ús principals, el model conceptual de dades, l'arquitectura del sistema, el disseny de les interfícies d'usuari i els patrons de disseny aplicats.
...
El disseny evita captures d' pantalla excessives i se centra en proporcionar una experiència fluida on l'usuari pugui navegar entre els quatre panells sense perdre el context dels filtres aplicats.
